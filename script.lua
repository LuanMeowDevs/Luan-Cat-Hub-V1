...
local Window = Fluent:CreateWindow({Title = "M3OWl Cat Hub V1 [Freemium]",SubTitle = "| By:Luan Cat",TabWidth = 180,Size = UDim2.fromOffset(660, 440),Acrylic = false,Theme = "Dark",MinimizeKey = Enum.KeyCode.End})
...
ToggleButton.Image = "rbxassetid://84722735301781" -- sua imagem
...
spawn(function()
  while wait(Sec) do
    if _G.Level then
      pcall(function()
        if plr.Data.Level.Value >= 2700 and plr.Character.HumanoidRootPart.Position.Y > -500 then
